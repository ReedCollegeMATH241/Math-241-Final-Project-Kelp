...
#multiplot(f14a, f14b, f14c, f14d, f14e, f14f, f14g, f14h, f14i, cols=3) #Beaverton large peak event corrected 
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.width=12, fig.height=12}
multiplot(w13f, s13f, su13f, f13f, w14f, s14f, su14f, f14f, cols=2)
```
